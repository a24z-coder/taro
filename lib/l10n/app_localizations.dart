...
abstract class AppLocalizations {
  ...
  ///
  /// In ru_RU, this message translates to:
  /// **'Сделай для {userName} расклад на саморазвитие и баланс по этим трем картам: {cards}. Ответ полностью на языке {lang}.'**
  ...
  ///
  /// In ru_RU, this message translates to:
  /// **'Ты опытный таролог. Пользователь {userName} вытянул карту(ы): {cards}. Вопрос пользователя: {question}. Сначала напиши с новой строки фразу: \'Ответ карт:\' и далее одним словом ответ \'Да\' или \'Нет\'. Затем добавь связное толкование 120–150 слов: 7–8 предложений о том, почему энергия {cards} ведёт к такому ответу и что это значит лично для {userName}. Упомяни имя {userName} минимум два раза, вставь 1–2 тематических эмодзи, избегай звездочек, решёток и любой разметки; пиши простым разговорным тоном. Ответ полностью на языке {lang}.'**
  ...
  ///
  /// In ru_RU, this message translates to:
  /// **'Переведи название карты Таро \"{cardName}\" на {lang}. Ответ должен содержать только переведенное название, без дополнительного текста или знаков препинания.'**
  ...
  ///
  /// In ru_RU, this message translates to:
  /// **'Ты опытный таролог. Пользователь {userName} спрашивает: \"{userQuestion}\". Ответь через расклад \"5 карт\". Карты даны по порядку: прошлое - {pastCard}; настоящее - {presentCard}; скрытое - {hiddenCard}; совет - {adviceCard}; итог - {outcomeCard}. Объясни значение каждой карты и их общий смысл. Ответ полностью на языке {lang}.'**
  ...
  ///
  /// In ru_RU, this message translates to:
  /// **'Сделай для {userName} месячный прогноз по этим картам: {cards}. Приветствие по имени {userName}. Ответ полностью на языке {lang}.'**
