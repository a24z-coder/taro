...
class AppLocalizationsRuRu extends AppLocalizationsRu {
  ...
  String five_cards_screen_prompt(
      ...
      Object userName,
      Object userQuestion) {
    return 'Ты опытный таролог. Пользователь $userName спрашивает: \"$userQuestion\". Ответь через расклад \"5 карт\". Карты даны по порядку: совет - $adviceCard; скрытое - $hiddenCard; итог - $outcomeCard; прошлое - $pastCard; настоящее - $presentCard. Объясни значение каждой карты и их общий смысл.';
  }
