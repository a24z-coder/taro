...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get main_screen_nav_spreads => 'Расклады';

  @override
  String get main_screen_nav_journal => 'Дневник';

  @override
  String get main_screen_nav_menu => 'Меню';

  @override
  String get main_screen_privacy_settings => 'Настройки конфиденциальности';

  @override
  String get consent_dialog_title => 'Персонализация контента';
  ...
  @override
  String get consent_analytics => 'Аналитика и улучшение приложения';

  @override
  String get consent_personalized_ads => 'Персонализированная реклама';

  @override
  String get consent_accept => 'Принять';

  @override
  String get consent_decline => 'Отклонить';

  @override
  String get consent_privacy_policy => 'Политика конфиденциальности';
  ...
  @override
  String get five_card_spread_past => 'Прошлое';

  @override
  String get five_card_spread_present => 'Настоящее';

  @override
  String get five_card_spread_hidden => 'Скрытое';

  @override
  String get five_card_spread_advice => 'Совет';

  @override
  String get five_card_spread_outcome => 'Итог';
  ...
  String chat_with_tarot_reader_screen_prompt(
      ...
      Object userName,
      Object userQuestion) {
    return 'Ты опытный таролог. Пользователь $userName спрашивает: \"$userQuestion\". Ответь через расклад \"Прошлое - Настоящее - Будущее\". Карты переданы так: прошлое - $card1; настоящее - $card2; будущее - $card3. Упоминай имя $userName не менее четырёх раз и обязательно связывай значения карт с вопросом. Соблюдай структуру:\n\n1) Приветствие по имени $userName.\n\n2) Заголовок: Расклад: Прошлое ($card1) - Настоящее ($card2) - Будущее ($card3).\n\n3) Блок ПРОШЛОЕ — $card1 (40-50 слов): три ключевых слова, символика карты и объяснение, как прошлые факты влияют на исход вопроса $userQuestion для $userName.\n\n4) Блок НАСТОЯЩЕЕ — $card2 (40-50 слов): ключевые слова, символика карты и текущие факторы, влияющие на ответ на вопрос $userQuestion.\n\n5) Блок БУДУЩЕЕ — $card3 (40-50 слов): ключевые слова, символика карты и вероятный сценарий развития ситуации по вопросу $userQuestion.\n\n6) Итог: короткий совет, позитивная аффирмация (20-30 слов) и чёткое оформление вывода.\n\nТребования: общий объём 180-220 слов, тёплый эзотерический тон, 3-5 тематических эмодзи; каждый блок отделяй двойным переводом строки (\n\n); запрещено использовать звездочки, решётки или другие знаки форматирования; пиши только простым текстом. Ответ полностью на языке $lang.';
  }
  ...
  String career_finance_spread_screen_prompt(Object adviceCard, Object lang,
    ...
    return 'Ты опытный таролог. Пользователь $userName спрашивает: \"$question\". Сделай расклад на карьеру и финансы по этим трём картам: прошлое – $pastCard: эта карта отражает прошлые влияния или опыт; настоящее – $presentCard: эта карта показывает текущую ситуацию; совет – $adviceCard: эта карта даёт рекомендацию на будущее. Ответ полностью на языке $lang.';
  }
  ...
  String five_cards_screen_prompt(
      ...
      Object userName,
      Object userQuestion) {
    return 'Ты опытный таролог. Пользователь $userName спрашивает: \"$userQuestion\". Ответь через расклад \"5 карт\". Карты даны по порядку: прошлое - $pastCard; настоящее - $presentCard; скрытое - $hiddenCard; совет - $adviceCard; итог - $outcomeCard. Объясни значение каждой карты и их общий смысл. Ответ полностью на языке $lang.';
  }

  @override
  String monthly_forecast_spread_screen_prompt(
      Object cards, Object lang, Object userName) {
    return 'Сделай для $userName месячный прогноз по этим картам: $cards. Приветствие по имени $userName. Ответ полностью на языке $lang.';
  }
...
class AppLocalizationsRuRu extends AppLocalizationsRu {
  ...
  String chat_with_tarot_reader_screen_prompt(
      ...
      Object userName,
      Object userQuestion) {
    return 'Ты опытный таролог. Пользователь $userName спрашивает: \"$userQuestion\". Ответь через расклад \"Прошлое - Настоящее - Будущее\". Карты переданы так: прошлое - $card1; настоящее - $card2; будущее - $card3. Упоминай имя $userName не менее четырёх раз и обязательно связывай значения карт с вопросом. Соблюдай структуру:\n\n1) Приветствие по имени $userName.\n\n2) Заголовок: Расклад: Прошлое ($card1) - Настоящее ($card2) - Будущее ($card3).\n\n3) Блок ПРОШЛОЕ — $card1 (40-50 слов): три ключевых слова, символика карты и объяснение, как прошлые факты влияют на исход вопроса $userQuestion для $userName.\n\n4) Блок НАСТОЯЩЕЕ — $card2 (40-50 слов): ключевые слова, символика карты и текущие факторы, влияющие на ответ на вопрос $userQuestion.\n\n5) Блок БУДУЩЕЕ — $card3 (40-50 слов): ключевые слова, символика карты и вероятный сценарий развития ситуации по вопросу $userQuestion.\n\n6) Итог: короткий совет, позитивная аффирмация (20-30 слов) и чёткое оформление вывода.\n\nТребования: общий объём 180-220 слов, тёплый эзотерический тон, 3-5 тематических эмодзи; каждый блок отделяй двойным переводом строки (\n\n); запрещено использовать символы *, # или другие знаки форматирования; пиши только простым текстом. Ответ полностью на языке $lang.';
  }
