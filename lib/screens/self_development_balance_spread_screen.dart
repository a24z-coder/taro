...
class _SelfDevelopmentBalanceSpreadScreenState extends State<SelfDevelopmentBalanceSpreadScreen> with SessionCheckMixin {
    ...
    try {
      ...
      _startReflectionSequence();
        ...
        try {
          ...
          debugPrint('[SelfDevBalance] ReviewService error: $e');
        }
    } catch (e) {
      setState(() {
  ...
  void _onSendReflection() async {
    ...
    try {
      ...
      final entry = JournalEntry(
        ...
        date: DateTime.now(),
        spreadKey: 'self_development',
        spreadType: AppLocalizations.of(context)!.self_development_balance_spread_screen_title,
        spreadTitle: AppLocalizations.of(context)!.self_development_balance_spread_screen_title,
        spreadDescription: AppLocalizations.of(context)!.self_development_balance_spread_screen_description,
